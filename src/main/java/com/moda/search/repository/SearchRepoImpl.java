...
public class SearchRepoImpl implements SearchRepo {
	...
	public String getName(String name) {
		GetResponse response = elsClient.getElsClient().prepareGet(IndexConstants.EMPLOYEE_DETAILS, IndexTypeConstants.EMPLOYEE, name).get();
	...
	@Override
	public String indexEmployee(XContentBuilder employee,  String docId) throws IOException {
		
		IndexResponse response = elsClient.getElsClient().prepareIndex(IndexConstants.EMPLOYEE_DETAILS, IndexTypeConstants.EMPLOYEE ,docId)
		        .setSource(employee)
		        .get();
